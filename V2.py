...
def tela_busca_por_artista():
    ...
    Button(telaBuscaArtista, text='Buscar', command=solicitar, font='arial 16', bg='#32cd32', fg='white').place(x=320, y=95)
...
def tela_busca_por_ano():
    ...
    Button(telaBuscaAno, command=buscar, text='BUSCAR', font='arial 13', fg='white', bg='#32cd32').place(x=320, y=135)
