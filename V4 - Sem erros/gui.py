...
def tela_dados_salvos():
  ...
  data = teste.coletar_albuns_cadastrados()
  nomes = data[0]
  cadastrados = data[1]
  ...
  ### Botão
  Button(telaDadosSalvos, text='Verificar', font='arial 12', command=teste.verificar_album, bg='#32cd32', fg='white').place(x=330, y=125)
...
""" def tela_cadastro():
  ...
  Button(telaCadastro, text="Cadatrar Álbum", font='arial 15', command=teste.cadastrar_album, bg='#32cd32', fg='white').place(x = 170, y = 400)
...
def tela_busca_por_artista():
    ...
    Button(telaBuscaArtista, text='Buscar', command=teste.busca_por_artista, font='arial 16', bg='#32cd32', fg='white').place(x=320, y=95)
...
def tela_busca_por_ano():
    ...
    Button(telaBuscaAno, command=teste.busca_por_ano, text='BUSCAR', font='arial 13', fg='white', bg='#32cd32').place(x=320, y=135)
